...
class AddEditViewController: UIViewController {
  ...
  func updateSaveButtonState() {
    ...
    toDo = ToDo(title: toDoItemTitle.text!, todoDescription: toDoItemDetails.text, priority: .medium, isCompleted: toDo?.isCompleted ?? false)
  ...
  @objc func saveItem() {
    ...
    if let _ = inEditMode {
      ...
      toDo = ToDo(title: toDoItemTitle.text!, todoDescription: toDoItemDetails.text, priority: .medium, isCompleted: toDo!.isCompleted)
